...
def return_duplicate_proteins(sequences_file):
    ...
    for prot in SeqIO.parse(sequences_file_fav, "fasta"): 
...
if __name__ == "__main__":
    ...
    sequences_file_unfav = "/home/matteo/polybox/MSc_ACLS/master_thesis/CRC_TRs/data/unfavorable_proteins_CRC.fasta"
    sequences_file_fav = "/home/matteo/polybox/MSc_ACLS/master_thesis/CRC_TRs/data/favorable_proteins_CRC.fasta"
